...
app.use(function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!FINALSLIST) return [3 /*break*/, 2];
                return [4 /*yield*/, scraper_1.getFinals()];
            case 1:
                // If FINALSLIST is not populated, get finals and filter just the CS courses
                FINALSLIST = (_a.sent()).filter(function (xm) { return xm.courseDept === "CS"; });
                _a.label = 2;
            case 2: 
            ...
            return [4 /*yield*/, ctx.render("./index.mst", {
                    semester: SEMESTER,
                    year: YEAR,
